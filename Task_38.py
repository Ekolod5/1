...
def choose_action(Contacts_1):
    while True:
        user_choice = input('1 - Найти контакт\n2 - Добавить контакт\n3 - Изменить контакт\n4 - Удалить контакт\n5 - Просмотреть все контакты\n0 - Выйти из приложения\n')
        print()
        if user_choice == '1':
            contact_list = read_file_to_dict(Contacts_1)
            find_number(contact_list)
        elif user_choice == '2':
            add_phone_number(Contacts_1)
        elif user_choice == '3':
            change_phone_number(Contacts_1)
        elif user_choice == '4':
            delete_contact(Contacts_1)
        elif user_choice == '5':
            show_contacts(Contacts_1)
        elif user_choice == '0':
            print('До свидания')
            break
        else:
